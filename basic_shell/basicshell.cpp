...
Basicshell::Basicshell(std::string sent_name) : shell_name(sent_name)
{
	// ctor
}

// A function that just clears the screen.
int Basicshell::clear_screen(arguments&)
{
...
void Basicshell::print_line(const std::string& sent_command)
{
...
int Basicshell::list_commands(arguments&)
{
